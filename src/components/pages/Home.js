    ...
    <div className="bg-gray-100 min-h-screen">
      <div className="container mx-auto py-12">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
          ...
          <Link to="/hero" className="text-primary font-bold hover:text-black">View More</Link>
        </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
          ...
          <Link to="/calculator" className="text-primary font-bold hover:text-black">View More</Link>
        </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          <Link to="/documentation" className="text-primary font-bold hover:text-black">Download</Link>
        </div>
